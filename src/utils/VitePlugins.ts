...
function flattenPlugins(input: PluginOption | PluginOption[] | undefined): Plugin[] {
  if (!input) return [];
 ...
 */
export function mergePlugins(opts: { internal?: PluginOption | PluginOption[]; apps?: Array<{ plugins?: PluginOption | PluginOption[] }> }): Plugin[] {
